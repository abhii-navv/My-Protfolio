    ...
    <div className="page-home-scroll">
      ...
      <section className="home-about-section" ref={aboutRef}>
        <div className="home-about-inner">
          ...
          <h2 className="home-about-title">About <em>Me</em></h2>
          <div className="hairline" />
          <div className="home-about-body">
            <p>I'm a Computer Science student with a passion for backend systems, real-time tech, and creative storytelling through photography. I've built full-stack projects, contributed to LiDAR-based research, and captured moments as part of my college media club.</p>
            <p>I enjoy combining technical depth with creative vision — whether engineering robust systems or framing the perfect shot.</p>
          </div>
          <div className="home-about-cta">
            <button className="home-about-btn" onClick={() => onNav('projects')}>
              View my Work
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </button>
            <button className="home-about-btn home-about-btn--ghost" onClick={() => onNav('about')}>
              Full Bio
            </button>
            <button className="home-about-btn home-about-btn--ghost" onClick={() => onNav('resume')}>
              Resume
            </button>
          </div>
        </div>
      ...
      <div className="skills-section">
        ...
        <div className="skills-flat-grid">
          {[
            ...
            <div key={s.name} className="skill-flat-item" title={s.name}>
              {s.icon
                ? <img src={s.icon} alt={s.name} className="skill-flat-icon" />
                : <span className="skill-flat-emoji">{s.emoji}</span>
              }
            </div>
          ))}
        </div>
