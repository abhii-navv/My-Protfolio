...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(el => {
    ...
    if (wantsResize) {
      // Detect landscape vs portrait from the actual image element
      ...
      if (imgEl && imgEl.naturalWidth && imgEl.naturalHeight) {
        ...
        if (isLandscape) {
          // Swap width/height for landscape images
          tempWidth = openedImageHeight || '420px';
          tempHeight = openedImageWidth || '320px';
        }
      }
      const onFirstEnd = ev => {
